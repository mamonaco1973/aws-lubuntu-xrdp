...
windows_dns="$(get_public_dns_by_name_tag "lubuntu-ad-admin")"
mate_dns="$(get_public_dns_by_name_tag "lubuntu-instance")"
...
echo "==============================================================================="
echo "VALIDATION RESULTS: AD + LUBUNTU DESKTOP"
echo "==============================================================================="
echo

if [ -z "${windows_dns}" ]; then
  print_kv "Windows AD Admin Host" "NOT FOUND (Name=lubuntu-ad-admin)"
else
  print_kv "Windows AD Admin Host" "${windows_dns}"
fi

if [ -z "${mate_dns}" ]; then
  print_kv "Lubuntu Desktop Host" "NOT FOUND (Name=lubuntu-instance)"
else
  print_kv "Lubuntu Desktop Host" "${mate_dns}"
fi
